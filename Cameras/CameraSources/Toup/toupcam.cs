...
/*
    ...
    We use P/Invoke to call into the toupcam.dll API, the c# class Tcam is a thin wrapper class to the native api of toupcam.dll.
...
public class Tcam : IDisposable
{
    ...
    /* get the version of this dll/so, which is: 57.26523.20240917 */
    ...
    /* enumerate Tcam cameras that are currently connected to computer */
    ...
    /*
        the object of Tcam must be obtained by static mothod Open or OpenByIndex, it cannot be obtained by obj = new Tcam (The constructor is private on purpose)
    */
    // camId: enumerated by EnumV2, null means the first enumerated camera
    public static Tcam Open(string camId)
    {
        SafeCamHandle tmphandle = Toupcam_Open(camId);
        if (tmphandle == null || tmphandle.IsInvalid || tmphandle.IsClosed)
            return null;
        return new Tcam(tmphandle);
    }
    ...
    */
    /*
        ...
        etc
    */
    public static Tcam OpenByIndex(uint index)
    {
